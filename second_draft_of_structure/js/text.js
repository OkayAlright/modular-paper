...
badfood=`<h1>Bad Food:</h1>
    ...
    <p>
        ...
        more than that of the food that made me sick. <br> 
    ...
    <p>
        ...
        it with me Brad. But why the fuck did he want to go to <br> 
    ...
    <p>
        ...
        am now stuck vomiting my brains out in our Hotel in Delaware. <br>
    </p>
    <p>
...
goodbye = `<h1>Goodbye:</h1>
		...
		<p>
			...
			to me in a calm, measured tone "of course." After she went to her van to drive back to Jersey, <br /> she cried for a
		...
		<p>
            ...
            full of typos and had no particular claim. I failed that semesters writing portfolio with a 2.25 out of 4. <br />
		</p>
		<p>
		...
		<p>
			...
			I could be found vomiting in a ditch along South Road after drinking too much vodka. <br />
		</p>
		<p>
			I never use to drink when I was young. I took too may medications. The doctors always told me my liver was <br /> in a
...
busride = `<h1>Bus Ride:</h1>
    <hr>
    <p>
    Given how I'n leaning against this window, I hope we don't <br> 
    hit a speed bump.<span id="bus_switch1"> I am always afraid my head will do through the glass</span>.
    <br> I have spent so much fucking time on this bus. <br>
    </p>
    <p>
    ...
    <p>
    Oh look, another accident. Fuck, that persons car on fire. <br> 
    Where are the police? Where is anyone? Is that car just <br> 
    on fire on the side of the road? It look like it has been <br> 
...
death = ` <h1>Death:</h1>
        ...
        <p>
            I have never seen death. I have someone dying and I have <br> 
            seen someone dead, but never the moment in between the <br> 
            two. But what is described as a "look in their eyes," or a <br> 
        ...
        <p>
            ...
            response when I find out someone had died. For a day or <br>    
            two after the news I am sad, but after a short time i move <br> 
        ...
        <p>
            My grandfathers death was particularly strange in that it <br> 
            was the day before my other grandmothers birthday. <br>    
        ...
        <p>
            My mothers side of the family talks about death plainly. <br> 
            We talk about those who passed. We talk about those who <br> 
            are passing. We talk about our own death as well. It is <br> 
...
python = `<h1>Python:</h1>
       ...
       <span class="gate" id="color_from_python_trigger" onclick='open_gate("color_from_python",color,blank);'> 
        ...
        <p id="python_switch_2"> Maybe they were right, I am going to be a gas station attendent. They told me otherwise, but I know.</p>
...
joy = ` <h1>Joy:</h1>
    ...
    the feeling of conducting an ensamble. The <br>
    ...
    known by the sound of a held breath. It is silent, but just for <br>
    a moment. But finally, there it is: the output you expected. <br>
    </p>
    <p>
    ...
    You computed numbers is mere seconds that, if considered as seconds, <br>
...
color = ` <h1>Color:</h1>
        ...
        <p> 
        I made my piles, the four that I could distinguish (red, blue, green, <br>
        and yellow), and I presented it to my teacher. She told me that it <br>
        was wrong and to try it again. I went back and couldn't <br>
        figure out what I had done wrong. After repeatedly saying that it <br>
        ...
        me: I know that purple is blue mixed with red, but it is not <br>
        ...
        when writing code. Programs that assist programmers often color text <br>
...
gender = ` <h1>Gender:</h1>
        ...
        months like my bipolar had me do. But when I looked <br>
        ...
        Coding as proven helpful in distracting me when I do. <br>
        </p>
        <p>
...
dreamsII = ` <h1> Dreams II: </h1>
        ...
        my dreams being so mundane. I guess that thing is a ly now. <br>
        Maybe this is my brain saying "fuck you, I can throw you into some  <br>
        Alice and Wonderland shit if I want to...I just don't always feel  <br>
        ...
        silent, but those fuckers at the police station were definitely <br>
